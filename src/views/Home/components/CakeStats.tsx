...
const CakeStats = () => {
  ...
  let bloodPerBlock = 0;
  if(farms && farms[0] && farms[0].bloodPerBlock){
    bloodPerBlock = new BigNumber(farms[0].bloodPerBlock).div(new BigNumber(10).pow(18)).toNumber();
  }
    ...
    <StyledCakeStats>
      <CardBody>
        ...
        <Row>
          ...
          <Text bold fontSize="14px" color="#FFFFFF">{bloodPerBlock}</Text>
        </Row>
      </CardBody>
    </StyledCakeStats>
  )
